	...
	Si (conFecha = 1) Entonces
		...
		Si (concepto = 2) Entonces
			...
			Si (concepto = 3) Entonces
				...
				//descuento del 20% al monto de pensiones
				//y el 10% ala Matricula
				Definir NueMatricula, NueMensualidad, MontoPagar Como Real
			...
			SiNo
				Si (concepto = 4) Entonces
					//condicion 4: toda la carrera descuento 40% al 
					//monto total de pensiones y el 20% alas matriculas 
					Definir NueMatricula, NueMensualidad, MontoPagar Como Real
